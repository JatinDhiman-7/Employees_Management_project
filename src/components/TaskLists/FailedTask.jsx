    ...
    return (
        <div className="p-5 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-white/10">
            ...
            <div className='flex justify-between items-center'>
                <h3 className='bg-gradient-to-r from-yellow-500 to-orange-600 text-white text-xs sm:text-sm px-3 py-1 rounded-full shadow'>
                    {data.category}
                </h3>
            ...
            {/* Failed Button */}
            <div className='mt-5'>
                <button className='w-full bg-gradient-to-r from-red-500 to-rose-600 text-white text-sm px-4 py-2 rounded-lg shadow-inner cursor-not-allowed opacity-80'>
                    Failed
                </button>
            </div>
        </div>
